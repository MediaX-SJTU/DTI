...
class VRModel(ModelMixin, ConfigMixin):
    ...
    def __init__(self,
        ...
        Args:
            ...
            dim (`int`, *optional*, defaults to 1536):
                Hidden dimension of the transformer
            ffn_dim (`int`, *optional*, defaults to 8960):
            ...
            alpha ('float', *optional*, defaults to 512.0):
    ...
    def forward(
        ...
        x, lq_latent= torch.cat(x), torch.cat(lq_latent) # B, L, C
